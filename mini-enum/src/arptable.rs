use crate::lib::arputil::{AF_UNSPEC, GetAdaptersAddresses, GetAdaptersAdressesFlags};
use std::collections::BTreeMap;
use std::ptr::null;
use windows_62_2::Win32::Foundation::ERROR_BUFFER_OVERFLOW;
use windows_62_2::Win32::Foundation::ERROR_INSUFFICIENT_BUFFER;
use windows_62_2::Win32::NetworkManagement::IpHelper::IP_ADAPTER_ADDRESSES_LH;
use windows_62_2::Win32::NetworkManagement::IpHelper::MIB_IPNET_TYPE;
use windows_62_2::Win32::NetworkManagement::IpHelper::{GetIpNetTable, MIB_IPNETTABLE};
use windows_62_2::Win32::Networking::WinSock::{SOCKADDR_IN, SOCKADDR_IN6};
...
fn print_interface(interface: &NetworkInterfaceInfo) {
